...
#' book \emph{Statistics: UnLocking the Power of Data}.
#' \code{locket} works much like \code{\link{demo}}, but the interface is
#' simplified.
#' 
...
#' @export 
#' 
locket <- function (name, execute = TRUE, view = !execute, echo = TRUE, 
