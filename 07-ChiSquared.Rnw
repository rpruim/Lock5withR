...
<<Example7.5>>=
chisq <- (85-80)^2/80 + (90-80)^2/80 + (79-80)^2/80 + (78-80)^2/80 + (68-80)^2/80; chisq
@
...
xchisq.test( jury, p=c(.54, .18, .12, .15, .01) ) # for expected counts
@

Things to notice:
\begin{itemize}
\item
\verb!jury <- c( 780, 117, 114, 384, 58)! is the way to enter this kind of data
by hand. 
\item
This time we need to tell \R\ what the null hypothesis is.  That's what
\verb! p=c(.54, .18, .12, .15, .01)! is for.
\end{itemize}
...
<<Example7.8>>=
prop.test(84, 200, correct=FALSE)
