...
<<Example5.1a, cache=TRUE, seed=1234>>=
...
<<Example5.4>>=
xqnorm(0.2, 75, 10)  # 20th percentile in Norm(75, 10)
qnorm(0.2, 75, 10)
@
...
<<Example5.5, tidy=FALSE>>=
(30 - 29.11) / 0.93              # z-score for 30 min
(31 - 29.11) / 0.93              # z-score for 31 min
xpnorm(c(30, 31), 29.11, 0.93)   # original normal distribution proportion between 30 and 31 min
xpnorm(c(0.957, 2.032))          # standardized distribution proportion between 30 and 31 min
pnorm(2.032) - pnorm(0.957)
@
%how to highlight opposite tail of xpnorm?
<<Example5.5b, tidy=FALSE>>=
