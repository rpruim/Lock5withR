...
<<Example4.19, seed=1234, cache=TRUE>>=
...
histogram(~prop, label = TRUE, type = "count", groups = (prop <= 0.2 | prop >= 0.8), 
          data=RandomizationDist)
@
<<Example4.20b>>=
...
<<Example4.27b, cache=TRUE, tidy=FALSE>>=
