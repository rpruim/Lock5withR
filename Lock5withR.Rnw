...
\title{Lock5 with R: A companion to Unlocking the Power of Data}
...
opts_template$set(fig2 = list(fig.height = 3, fig.width = 2, out.width=".47\\textwidth"))
...
<<child="00-RStudio.Rnw", eval=FALSE>>=
@
...
<<child="04-HypothesisTests.Rnw", eval=FALSE>>=
@


<<child="05-Distributions.Rnw", eval=FALSE>>=
@

<<child="06-InferenceMeansProportions.Rnw", eval=FALSE>>=
@

<<child="07-ChiSquared.Rnw", eval=FALSE>>=
@

<<child="08-ANOVA.Rnw", eval=FALSE>>=
@

<<child="09-Regression.Rnw", eval=FALSE>>=
@

<<child="10-MultipleRegression.Rnw", eval=FALSE>>=
@
