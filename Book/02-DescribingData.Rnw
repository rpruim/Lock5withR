...
gf_histogram( ~ Longevity, binwidth = 5, type = "count", data = MammalLongevity)
@
...
gf_histogram( ~ Longevity, type = "count", data = MammalLongevity, bins = 8)
gf_histogram( ~ Longevity, type = "count", data = MammalLongevity, bins = 15)
gf_histogram( ~ Longevity, type = "count", data = MammalLongevity, bins = 30)
@
...
gf_histogram( ~ Longevity, type = "count", data = MammalLongevity, binwidth = 10)
gf_histogram( ~ Longevity, type = "count", data = MammalLongevity, binwidth = 5)
gf_histogram( ~ Longevity, type = "count", data = MammalLongevity, binwidth = 2)
@
...
The various options available for the \function{gf_histogram()} function enable us to replicate Figure 2.8, some including centering, adding counts, labels, and limit to the y-axis (similar for x-axis).
