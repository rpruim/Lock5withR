...
gf_dotplot( ~ DesMoines, binwidth = 1, dotsize = 2, stackratio = 6, data = April14Temps) %>% gf_lims(x = c(35, 80))
gf_dotplot( ~ SanFrancisco, binwidth = 1, dotsize = 1, stackratio = 4, data = April14Temps) %>% gf_lims(x = c(45, 65))
@
