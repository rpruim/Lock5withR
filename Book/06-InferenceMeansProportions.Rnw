...
gf_dotplot(~prop, binwidth = .02, dotsize = .015, data = P.05)

P.10 <- do(2000) * rflip(50, .10)
gf_dotplot(~prop, binwidth = .02, dotsize = .015, data = P.10)

P.25 <- do(2000) * rflip(50, .25)
gf_dotplot(~prop, binwidth = .02, dotsize = .03, data = P.25)

P.50 <- do(2000) * rflip(50, .50)
gf_dotplot(~prop, binwidth = .02, dotsize = .03, data = P.50)

P.90 <- do(2000) * rflip(50, .90)
gf_dotplot(~prop, binwidth = .02, dotsize = .015, data = P.90)

P.99 <- do(2000) * rflip(50, .99)
gf_dotplot(~prop, binwidth = .02, dotsize = .002, data = P.99)
@
\authNote{irregular bin sizes, count became density}
...
gf_dotplot(~prop, binwidth = .04, dotsize = .01, data = n25)

n200 <- do(2000) * rflip(200, .10)
gf_dotplot(~prop, binwidth = .005, dotsize = .04, data = n200)
@
\authNote{irregular bin sizes, count became density}
